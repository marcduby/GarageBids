package com.winterdev.garagebid.service;
		...
		public void endElement(String uri, String localName, String name) throws SAXException {
			...
			if (this.currentEvent != null) {
				if (localName.equalsIgnoreCase(ID)) {
					...
					currentEvent.setTitle(builder.toString().trim());
				} else if (localName.equalsIgnoreCase(STREET)) {
					currentEvent.setStreet(builder.toString().trim());
				} else if (localName.equalsIgnoreCase(CITY)) {
					currentEvent.setCity(builder.toString().trim());
				} else if (localName.equalsIgnoreCase(STATE)) {
					currentEvent.setState(builder.toString().trim());
				} else if (localName.equalsIgnoreCase(ZIP)) {
					currentEvent.setZip(builder.toString().trim());
				} else if (localName.equalsIgnoreCase(LATITUDE)) {
					currentEvent.setLatitude(Double.parseDouble(builder.toString().trim()));
				} else if (localName.equalsIgnoreCase(LONGITUDE)) {
					currentEvent.setLongitude(Double.parseDouble(builder.toString().trim()));
				} else if (localName.equalsIgnoreCase(DESCRIPTION)) {
					currentEvent.setDescription(builder.toString().trim());
				} else if (localName.equalsIgnoreCase(RATING)) {
					currentEvent.setRating(Float.parseFloat(builder.toString().trim()));
				} else if (localName.equalsIgnoreCase(DISTANCE)) {
					currentEvent.setDistance(Double.parseDouble(builder.toString().trim()));
